    ...
    return (
        <div className="min-h-screen bg-gray-950 text-gray-100 font-sans flex flex-col">
            <header className="border-b border-gray-800 bg-gray-900/80 sticky top-0 z-50">
                <div className="max-w-[90rem] mx-auto px-6 h-20 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <h1 className="text-xl font-bold tracking-tight text-white tracking-widest"><span className="text-indigo-400">FUSE</span> / ANALYTICS HUB</h1>
                    </div>
                </div>
            </header>
            ...
            <main className="flex-1 max-w-[90rem] mx-auto px-6 py-12 w-full">
                <div className="mb-12">
                    <h2 className="text-4xl font-black text-white mb-4">Beamtime Insights</h2>
                    <p className="text-gray-400 text-lg max-w-3xl">Real-time data visualization of facility resource utilization, dataset growth, and experimental computational jobs.</p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
                    {[
                        ...
                        <div key={i} className="bg-gray-900/40 border border-gray-800 rounded-2xl p-6 shadow-xl relative overflow-hidden">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
                    ...
                    <div className="bg-gray-900/40 border border-gray-800 rounded-3xl p-8 shadow-2xl">
                        <h3 className="text-xl font-bold text-white mb-8 flex items-center gap-3">
                            <span className="w-2 h-6 bg-indigo-500 rounded-full"></span>
                            Data Acquisition Throughput (24h)
                        </h3>
                        <div className="h-64 flex items-end justify-between gap-2 px-2 border-l border-b border-gray-800 relative">
                        ...
                        <table className="w-full min-w-[800px]">
                            <thead>
                                <tr className="text-left border-b border-gray-800">
                                    <th className="pb-4 text-[10px] font-black text-gray-500 uppercase tracking-widest">Job ID</th>
                                    <th className="pb-4 text-[10px] font-black text-gray-500 uppercase tracking-widest">Process Name</th>
                                    <th className="pb-4 text-[10px] font-black text-gray-500 uppercase tracking-widest">Assigned PI</th>
                                    <th className="pb-4 text-[10px] font-black text-gray-500 uppercase tracking-widest">Status</th>
                                    <th className="pb-4 text-[10px] font-black text-gray-500 uppercase tracking-widest">Execution Progress</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-gray-800/50">
                                {[
                                    ...
                                    <tr key={i} className="hover:bg-gray-800/20 transition-colors group">
                                        <td className="py-4 font-mono text-xs text-indigo-400">{job.id}</td>
                                        <td className="py-4 text-sm font-bold text-gray-100">{job.name}</td>
                                        <td className="py-4 text-sm text-gray-400 font-medium">{job.pi}</td>
                                        <td className="py-4">
                                        ...
                                        <td className="py-4 w-48">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className="text-[10px] font-bold text-gray-500">{job.progress}%</span>
                                            </div>
                                        </td>
                                    </tr>
                                ))}
