        ...
        <div className="min-h-screen bg-gray-950 text-gray-100 font-sans selection:bg-purple-500 selection:text-white pb-20">
                ...
                <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <Link href="/" className="flex items-center gap-2 group">
                            <div className="w-8 h-8 rounded-lg bg-gray-800 flex items-center justify-center text-gray-400 group-hover:text-white group-hover:bg-gray-700 transition-all">
                                &larr;
                            </div>
                            <span className="text-sm font-bold text-gray-400 group-hover:text-white transition-colors">Back to Home</span>
                        </Link>
                    </div>
            ...
            <section className="relative pt-24 pb-16 px-6 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto flex flex-col items-center text-center relative z-10">
                    ...
                    <h2 className="text-7xl font-extrabold tracking-tighter mb-8 bg-clip-text text-transparent bg-gradient-to-b from-gray-100 to-gray-500">
                        Autonomous Experiments & <br/>
                        <span className="text-purple-400 italic">Fast Data Pipelines</span>
                    </h2>
                    ...
                    <div className="w-full max-w-5xl rounded-3xl overflow-hidden border border-gray-800 bg-gray-900/50 relative aspect-[21/9] shadow-2xl">
                        <Image 
                        ...
                        <div className="absolute bottom-6 left-6 right-6 flex items-center justify-between">
                            <span className="text-white font-bold bg-gray-900/80 backdrop-blur px-4 py-2 rounded-xl border border-gray-700">Closed-Loop Autonomous Experimentation</span>
                            <span className="text-gray-500 text-sm italic">Inspired by [Noack2019]</span>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="max-w-7xl mx-auto px-6 py-20">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="p-8 rounded-3xl border border-gray-800 bg-gray-900/50 hover:bg-gray-900 transition-colors">
                        <div className="w-12 h-12 rounded-2xl bg-purple-500/20 flex items-center justify-center text-purple-400 mb-6 font-bold text-xl">01</div>
                        <h3 className="text-2xl font-bold mb-4">Autonomous Workflows</h3>
                    ...
                    <div className="p-8 rounded-3xl border border-gray-800 bg-gray-900/50 hover:bg-gray-900 transition-colors">
                        <div className="w-12 h-12 rounded-2xl bg-indigo-500/20 flex items-center justify-center text-indigo-400 mb-6 font-bold text-xl">02</div>
                        <h3 className="text-2xl font-bold mb-4">Fast Feedback Loop</h3>
                        <p className="text-gray-400 leading-relaxed">
                    ...
                    <div className="p-8 rounded-3xl border border-gray-800 bg-gray-900/50 hover:bg-gray-900 transition-colors">
                        <div className="w-12 h-12 rounded-2xl bg-cyan-500/20 flex items-center justify-center text-cyan-400 mb-6 font-bold text-xl">03</div>
                        <h3 className="text-2xl font-bold mb-4">Intelligent Optimization</h3>
                        <p className="text-gray-400 leading-relaxed">
            ...
            <section className="bg-gray-900/30 border-y border-gray-800 py-32 px-6">
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="bg-gray-900 p-8 rounded-3xl border border-gray-800 space-y-4">
                                <span className="text-indigo-400 font-black text-3xl">P08</span>
                                <h5 className="font-bold">PETRA III, DESY</h5>
                                <p className="text-sm text-gray-500">X-ray Photon Correlation Spectroscopy focus.</p>
                            </div>
                            <div className="bg-gray-900 p-8 rounded-3xl border border-gray-800 space-y-4 translate-y-8">
                                <span className="text-purple-400 font-black text-3xl">P10</span>
                                <h5 className="font-bold">PETRA III, DESY</h5>
                                <p className="text-sm text-gray-500">X-ray and Neutron reflectivity exploration.</p>
                            </div>
                            <div className="bg-gray-900 p-8 rounded-3xl border border-gray-800 space-y-4">
                                <span className="text-cyan-400 font-black text-3xl">RS</span>
                                <h5 className="font-bold">REFSANS, MLZ</h5>
                            ...
                            <div className="bg-gray-900 p-8 rounded-3xl border border-gray-800 space-y-4 translate-y-8">
                                ...
                                <h5 className="font-bold">Transferability</h5>
            ...
            <section className="max-w-7xl mx-auto px-6 py-32">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {[
                        ...
                        <div key={index} className="flex items-center gap-4 bg-gray-900/20 p-6 rounded-2xl border border-gray-800/50">
            ...
            <section className="max-w-4xl mx-auto px-6 py-20 bg-gradient-to-br from-indigo-900/10 to-transparent rounded-[4rem] border border-gray-800 mb-20">
