    ...
    return (
        <div className="min-h-screen bg-gray-950 text-gray-100 font-sans flex flex-col">
            <header className="border-b border-gray-800 bg-gray-900/80 sticky top-0 z-50">
                <div className="max-w-[90rem] mx-auto px-6 h-20 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <h1 className="text-xl font-bold tracking-tight text-white tracking-widest"><span className="text-emerald-400">FUSE</span> / DEPOSIT PORTAL</h1>
                    </div>
                </div>
            </header>
            ...
            <main className="flex-1 max-w-4xl mx-auto px-6 py-12 w-full">
                <div className="mb-12">
                    <h2 className="text-4xl font-black text-white mb-4">Submit Reference Data</h2>
                    <p className="text-gray-400 text-lg">Contribute high-quality experimental benchmarks to the FUSE Reference Library. Your submission will undergo peer validation before being tagged as a "Gold Standard".</p>
                </div>
                    ...
                    {[1, 2, 3].map((s) => (
                        <div key={s} className="flex items-center gap-4 flex-1 last:flex-none">
                            <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold border-2 transition-all ${
                                ...
                                step > s ? 'bg-emerald-900/40 border-emerald-500 text-emerald-400' : 
                                'bg-gray-900 border-gray-800 text-gray-600'
                            }`}>
                                {s}
                            </div>
                            {s < 3 && <div className={`h-[2px] flex-1 rounded-full ${step > s ? 'bg-emerald-500' : 'bg-gray-800'}`}></div>}
                        </div>
                    ))}
                </div>

                <div className="bg-gray-900/40 border border-gray-800 rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden transition-all">
                        ...
                        <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
                            ...
                            <div className="pt-8 flex justify-end">
                                <button 
                                    ...
                                    onClick={handleNext}
                                    className="px-10 py-4 bg-emerald-500 hover:bg-emerald-400 disabled:bg-gray-800 disabled:text-gray-600 text-gray-950 font-black rounded-xl transition-all shadow-xl shadow-emerald-950/20 active:scale-95 uppercase tracking-widest text-xs"
                                >
                                    Continue to Details
                                </button>
                            </div>
                    ...
                    {step === 2 && (
                        <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea 
                                    rows={5}
                                    className="w-full bg-gray-950 border border-gray-800 rounded-xl px-4 py-4 focus:ring-2 focus:ring-emerald-500 outline-none transition-all resize-none" 
                            ...
                            <div className="pt-8 flex justify-between">
                                <button onClick={handleBack} className="px-10 py-4 text-gray-400 font-bold hover:text-white transition-colors uppercase tracking-widest text-xs">
                                    Go Back
                                </button>
                                <button 
                                    onClick={handleNext}
                    ...
                    {step === 3 && (
                        <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500 text-center">
                             ...
                             <h3 className="text-2xl font-black text-white">Initializing Secure Transfer...</h3>
                             <p className="text-gray-400 max-w-sm mx-auto">Please wait while we establish an encrypted bridge to the primary DAPHNE data cluster for your files.</p>
